...
- Retrieval method: SAGE hybrid CC-BY open access. Publisher PDF at <https://journals.sagepub.com/doi/pdf/10.1089/cap.2021.0034> works in a regular browser but is blocked by Cloudflare for automated fetches. Open in browser to download.

### 2. Record #133 — Mirtazapine for chronic insomnia (MIRAGE)
- Authors: Nguyen et al., 2025
- Journal: *Age and Ageing*
- PMID: 40135470
- DOI: 10.1093/ageing/afaf050
- Retrieval method: paywalled on Oxford Academic. Try U Calgary EZproxy: <https://login.ezproxy.lib.ucalgary.ca/login?url=https://doi.org/10.1093/ageing/afaf050>. Alternative: email corresponding author Patrick V-Q Nguyen (CHUM Pharmacy, Montreal) for a reprint.

### 3. Record #113 — Semaglutide for cognitive dysfunction in MDD (DROPPED)
